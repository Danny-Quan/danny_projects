...
<section class="setup_enterprenuership_section">
    <div class="setup_enterprenuership_header_bg">
<h1 class="text-uppercase text-center">set up enterpreneurship challenge</h1>
    </div>
    <div class="container">
        <p>
